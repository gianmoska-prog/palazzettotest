(() => {
  ...
  const rows = [
    ...
    ["Caprarola (VT)", "Caprarola (VT)", "Caprarola (VT)", "Caprarola (VT)", "Caprarola (VT)"],
    ...
    ["Guest house · Caprarola (VT) · Tuscia", "Guest house · Caprarola (VT) · Tuscia", "Maison d'hôtes · Caprarola (VT) · Tuscia", "Casa de huéspedes · Caprarola (VT) · Tuscia", "Gästehaus · Caprarola (VT) · Tuscia"],
    ...
    ["Una dimora nel centro storico di Caprarola, pensata per soggiorni autentici, confortevoli e indipendenti.", "A home in Caprarola's historic centre, designed for comfortable and independent stays with a true sense of place.", "Une demeure dans le centre historique de Caprarola, pensée pour des séjours confortables, indépendants et ancrés dans les lieux.", "Una casa en el casco histórico de Caprarola, pensada para estancias cómodas, independientes y vinculadas al lugar.", "Ein Haus in Caprarolas Altstadt für komfortable, unabhängige Aufenthalte mit echtem Bezug zum Ort."],
    ...
    ["Una selezione fotografica autentica degli ambienti, degli accessi e del borgo che circonda la dimora.", "An authentic photographic selection of the interiors, entrances and village surrounding the house.", "Une sélection photographique authentique des intérieurs, des accès et du village qui entoure la demeure.", "Una selección fotográfica auténtica de los interiores, los accesos y el pueblo que rodea la casa.", "Eine authentische Fotoauswahl der Innenräume, Zugänge und des Ortes rund um das Haus."],
    ...
    ["Bagno privato, comfort curati e nomi ispirati agli ambienti di Palazzo Farnese.", "Private bathrooms, thoughtful comforts and names inspired by the rooms of Palazzo Farnese.", "Salle de bains privée, confort soigné et noms inspirés des salles du Palazzo Farnese.", "Baño privado, comodidades cuidadas y nombres inspirados en las salas del Palazzo Farnese.", "Eigenes Bad, sorgfältig ausgewählter Komfort und Namen, die von den Räumen des Palazzo Farnese inspiriert sind."],
    ["Ospitalità", "Hospitality", "Hospitalité", "Hospitalidad", "Gastlichkeit"],
    ["Spazi curati, soggiorni flessibili.", "Thoughtful spaces, flexible stays.", "Des espaces soignés, des séjours flexibles.", "Espacios cuidados, estancias flexibles.", "Sorgfältig gestaltete Räume, flexible Aufenthalte."],
    ...
    ["Una cucina comune attrezzata, check-in autonomo e tutto ciò che serve per vivere il soggiorno in libertà.", "A fully equipped shared kitchen, self check-in and everything you need to enjoy your stay freely.", "Une cuisine commune équipée, une arrivée autonome et tout ce qu'il faut pour vivre votre séjour en toute liberté.", "Una cocina común equipada, llegada autónoma y todo lo necesario para disfrutar de la estancia con libertad.", "Eine ausgestattete Gemeinschaftsküche, selbstständiger Check-in und alles, was Sie für einen freien, unabhängigen Aufenthalt brauchen."],
    ...
    ["Colazione e pasti, secondo i tuoi ritmi.", "Breakfast and meals, at your own pace.", "Petit-déjeuner et repas, à votre rythme.", "Desayuno y comidas, a tu ritmo.", "Frühstück und Mahlzeiten, in Ihrem Rhythmus."],
    ["La cucina comune è attrezzata con tutto il necessario per preparare in autonomia colazione e pasti, con la libertà di organizzare ogni momento del soggiorno.", "The shared kitchen has everything you need to prepare breakfast and meals independently, giving you the freedom to organise every moment of your stay.", "La cuisine commune offre tout le nécessaire pour préparer petit-déjeuner et repas en toute autonomie, avec la liberté d'organiser chaque moment de votre séjour.", "La cocina común cuenta con todo lo necesario para preparar el desayuno y las comidas con autonomía y organizar cada momento de la estancia a tu ritmo.", "Die Gemeinschaftsküche bietet alles, was Sie für die selbstständige Zubereitung von Frühstück und Mahlzeiten brauchen – für einen Aufenthalt ganz nach Ihrem eigenen Rhythmus."],
    ...
    ["Il check-in è disponibile dalle 15:00 e avviene in autonomia tramite key box, dopo l'invio dei documenti necessari secondo la normativa vigente. Le istruzioni vengono comunicate prima dell'arrivo. Il check-out deve essere effettuato entro le 10:00.", "Check-in is available from 15:00 and is completed independently via key box after the documents required by law have been submitted. Instructions are provided before arrival. Check-out must be completed by 10:00.", "L'arrivée est possible à partir de 15 h et s'effectue en autonomie via une boîte à clés, après l'envoi des documents requis par la réglementation. Les instructions sont communiquées avant l'arrivée. Le départ doit avoir lieu avant 10 h.", "La entrada está disponible desde las 15:00 y se realiza de forma autónoma mediante caja de llaves tras enviar los documentos exigidos por la normativa. Las instrucciones se facilitan antes de la llegada. La salida debe realizarse antes de las 10:00.", "Der Check-in ist ab 15:00 Uhr selbstständig per Schlüsselbox möglich, nachdem die gesetzlich erforderlichen Dokumente übermittelt wurden. Die Anleitung erhalten Sie vor der Anreise. Der Check-out muss bis 10:00 Uhr erfolgen."],
    ...
    ["Richiedi la disponibilità per il tuo soggiorno.", "Request availability for your stay.", "Demandez les disponibilités pour votre séjour.", "Solicita disponibilidad para tu estancia.", "Fragen Sie die Verfügbarkeit für Ihren Aufenthalt an."],
    ["Indica il periodo, il numero di ospiti e i tuoi recapiti: prepareremo una richiesta di disponibilità da inviare a Il Palazzetto Farnese tramite il programma e-mail del dispositivo.", "Enter your preferred dates, number of guests and contact details: we will prepare an availability enquiry to send to Il Palazzetto Farnese using your device's email app.", "Indiquez les dates souhaitées, le nombre de personnes et vos coordonnées : nous préparerons une demande de disponibilité à envoyer à Il Palazzetto Farnese depuis l'application e-mail de votre appareil.", "Indica las fechas, el número de huéspedes y tus datos de contacto: prepararemos una solicitud de disponibilidad para enviar a Il Palazzetto Farnese desde la aplicación de correo del dispositivo.", "Geben Sie Zeitraum, Gästezahl und Kontaktdaten an: Wir erstellen eine Verfügbarkeitsanfrage, die Sie über das E-Mail-Programm Ihres Geräts an Il Palazzetto Farnese senden können."],
    ...
    ["Scala d'ingresso de Il Palazzetto Farnese", "Entrance staircase of Il Palazzetto Farnese", "Escalier d'entrée d'Il Palazzetto Farnese", "Escalera de entrada de Il Palazzetto Farnese", "Eingangstreppe von Il Palazzetto Farnese"],
    ["Scala d'ingresso della dimora", "Entrance staircase of the house", "Escalier d'entrée de la demeure", "Escalera de entrada de la casa", "Eingangstreppe des Hauses"],
    ["L'ingresso della dimora", "The entrance to the house", "L'entrée de la demeure", "La entrada de la casa", "Der Eingang des Hauses"],
    ["Scala interna ad arco della dimora", "Arched internal staircase of the house", "Escalier intérieur voûté de la demeure", "Escalera interior con arco de la casa", "Gewölbte Innentreppe des Hauses"],
    ...
    ["Scala interna con pianta ornamentale", "Internal staircase with decorative plant", "Escalier intérieur avec plante décorative", "Escalera interior con planta ornamental", "Innentreppe mit Zierpflanze"],
    ["I dettagli della dimora", "Details of the house", "Les détails de la demeure", "Los detalles de la casa", "Details des Hauses"],
    ["Area comune con cucina, tavolo e salotto", "Shared area with kitchen, dining table and lounge", "Espace commun avec cuisine, table et salon", "Zona común con cocina, mesa y salón", "Gemeinschaftsbereich mit Küche, Esstisch und Wohnbereich"],
    ...
    ["Affaccio dalla dimora verso il vicolo storico", "View from the house towards the historic lane", "Vue depuis la demeure vers la ruelle historique", "Vista desde la casa hacia la calle histórica", "Blick vom Haus in die historische Gasse"],
    ["Il borgo fuori dalla porta", "The village outside the door", "Le village au pas de la porte", "El pueblo al salir por la puerta", "Der Ort direkt vor der Tür"],
    ...
    ["Stanza del Mappamondo", "Map Room", "Chambre du Mappamondo", "Habitación del Mappamondo", "Mappamondo-Zimmer"],
    ...
    ["Targa della Stanza del Mappamondo", "Map Room plaque", "Plaque de la Chambre du Mappamondo", "Placa de la Habitación del Mappamondo", "Türschild des Mappamondo-Zimmers"],
    ...
    ["Stanza del Belvedere Farnese", "Belvedere Farnese Room", "Chambre du Belvedere Farnese", "Habitación del Belvedere Farnese", "Belvedere-Farnese-Zimmer"],
    ...
    ["Targa della Stanza del Belvedere Farnese", "Belvedere Farnese Room plaque", "Plaque de la Chambre du Belvedere Farnese", "Placa de la Habitación del Belvedere Farnese", "Türschild des Belvedere-Farnese-Zimmers"],
    ...
    ["Camera doppia", "Double room", "Chambre double", "Habitación doble", "Doppelzimmer"],
    ["La Stanza del Mappamondo è una camera doppia di circa 14 m² con bagno privato. Su richiesta e previa conferma è possibile aggiungere un letto singolo extra.", "The Map Room is a double room of approximately 14 m² with a private bathroom. An extra single bed can be added on request and subject to confirmation.", "La Chambre du Mappamondo est une chambre double d'environ 14 m² avec salle de bains privée. Un lit simple supplémentaire peut être ajouté sur demande et sous réserve de confirmation.", "La Habitación del Mappamondo es una habitación doble de unos 14 m² con baño privado. Se puede añadir una cama individual extra bajo petición y confirmación.", "Das Mappamondo-Zimmer ist ein ca. 14 m² großes Doppelzimmer mit eigenem Bad. Auf Anfrage und nach Bestätigung kann ein zusätzliches Einzelbett bereitgestellt werden."],
    ["Letto singolo extra disponibile esclusivamente su richiesta.", "Extra single bed available exclusively on request.", "Lit simple supplémentaire disponible exclusivement sur demande.", "Cama individual extra disponible exclusivamente bajo petición.", "Zusätzliches Einzelbett ausschließlich auf Anfrage verfügbar."],
    ["Camera tripla", "Triple room", "Chambre triple", "Habitación triple", "Dreibettzimmer"],
    ["La Stanza del Belvedere Farnese è una camera tripla di circa 20 m² con bagno privato. Su richiesta e previa conferma è possibile aggiungere un letto singolo extra.", "The Belvedere Farnese Room is a triple room of approximately 20 m² with a private bathroom. An extra single bed can be added on request and subject to confirmation.", "La Chambre du Belvedere Farnese est une chambre triple d'environ 20 m² avec salle de bains privée. Un lit simple supplémentaire peut être ajouté sur demande et sous réserve de confirmation.", "La Habitación del Belvedere Farnese es una habitación triple de unos 20 m² con baño privado. Se puede añadir una cama individual extra bajo petición y confirmación.", "Das Belvedere-Farnese-Zimmer ist ein ca. 20 m² großes Dreibettzimmer mit eigenem Bad. Auf Anfrage und nach Bestätigung kann ein zusätzliches Einzelbett bereitgestellt werden."],
    ["Tipologia della camera", "Room type", "Type de chambre", "Tipo de habitación", "Zimmertyp"],
    ...
    ["Scopri i servizi", "Discover the amenities", "Découvrir les services", "Descubrir los servicios", "Ausstattung entdecken"],
    ...
    ["Visualizzatore fotografie delle camere", "Room photo viewer", "Visionneuse de photos des chambres", "Visor de fotografías de las habitaciones", "Zimmerfoto-Ansicht"],
    ...
    ["Fotografia precedente", "Previous photograph", "Photo précédente", "Fotografía anterior", "Vorheriges Foto"],
    ["Fotografia successiva", "Next photograph", "Photo suivante", "Fotografía siguiente", "Nächstes Foto"],
    ["Tutto il necessario", "Everything you need", "Tout le nécessaire", "Todo lo necesario", "Alles, was Sie brauchen"],
    ["Una cucina completa, da vivere in autonomia.", "A complete kitchen for an independent stay.", "Une cuisine complète pour un séjour en autonomie.", "Una cocina completa para una estancia independiente.", "Eine komplett ausgestattete Küche für einen unabhängigen Aufenthalt."],
    ...
    ["Arrivo e partenza", "Arrival and departure", "Arrivée et départ", "Llegada y salida", "An- und Abreise"],
    ["Check-in dalle 15:00 · check-out entro le 10:00.", "Check-in from 15:00 · check-out by 10:00.", "Arrivée à partir de 15 h · départ avant 10 h.", "Entrada desde las 15:00 · salida antes de las 10:00.", "Check-in ab 15:00 Uhr · Check-out bis 10:00 Uhr."],
    ...
    ["Regole della casa", "House rules", "Règles de la maison", "Normas de la casa", "Hausregeln"],
    ["Animali non ammessi.", "Pets are not allowed.", "Animaux non admis.", "No se admiten animales.", "Haustiere sind nicht gestattet."],
