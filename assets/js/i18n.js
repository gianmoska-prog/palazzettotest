(() => {
  ...
  const rows = [
    ...
    ["Il check-in è disponibile dalle 15:00 e avviene in autonomia tramite key box, dopo l'invio dei documenti necessari secondo la normativa vigente. Le istruzioni vengono comunicate prima dell'arrivo. Il check-out deve essere effettuato entro le 11:00.", "Check-in is available from 15:00 and is completed independently via key box after the documents required by law have been submitted. Instructions are provided before arrival. Check-out must be completed by 11:00.", "L'arrivée est possible à partir de 15 h et s'effectue en autonomie via une boîte à clés, après l'envoi des documents requis par la réglementation. Les instructions sont communiquées avant l'arrivée. Le départ doit avoir lieu avant 11 h.", "La entrada está disponible desde las 15:00 y se realiza de forma autónoma mediante caja de llaves tras enviar los documentos exigidos por la normativa. Las instrucciones se facilitan antes de la llegada. La salida debe realizarse antes de las 11:00.", "Der Check-in ist ab 15:00 Uhr selbstständig per Schlüsselbox möglich, nachdem die gesetzlich erforderlichen Dokumente übermittelt wurden. Die Anleitung erhalten Sie vor der Anreise. Der Check-out muss bis 11:00 Uhr erfolgen."],
    ...
    ["Check-in dalle 15:00 · check-out entro le 11:00.", "Check-in from 15:00 · check-out by 11:00.", "Arrivée à partir de 15 h · départ avant 11 h.", "Entrada desde las 15:00 · salida antes de las 11:00.", "Check-in ab 15:00 Uhr · Check-out bis 11:00 Uhr."],
